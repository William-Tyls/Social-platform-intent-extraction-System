...
from .config import HumanConfig, rand, rand_range, async_sleep_ms, rand_unit
...
from .keyboard import _build_cdp_keydown, _build_cdp_keyup
...
async def _type_shift_symbol(
    ...
    if cdp_session is not None:
        ...
        await cdp_session.send("Input.dispatchKeyEvent", _build_cdp_keydown(ch, code, key_code))
        await async_sleep_ms(rand_range(cfg.key_hold))

        await cdp_session.send("Input.dispatchKeyEvent", _build_cdp_keyup(ch, code, key_code))
