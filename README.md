...
**Python** — see [`tools/`](tools/):
- [`tutorials/basic.py`](tools/tutorials/basic.py) — Launch and load a page
- [`tutorials/persistent_context.py`](tools/tutorials/persistent_context.py) — Persistent profile with cookie/localStorage persistence
- [`tests/stealth_test.py`](tools/tests/stealth_test.py) — Run against 6 detection sites
- [`tests/fingerprint_scan_test.py`](tools/tests/fingerprint_scan_test.py) — Test against fingerprint-scan.com and CreepJS
...
|-----------|-------|----------|---------|
| [browser-use](https://github.com/browser-use/browser-use) | 70K | Python | [`browser_use_example.py`](tools/integrations/browser_use_example.py) |
| [Crawl4AI](https://github.com/unclecode/crawl4ai) | 58K | Python | [`crawl4ai_example.py`](tools/integrations/crawl4ai_example.py) |
| [Crawlee](https://github.com/apify/crawlee-python) | 8.6K | Python | [`crawlee_example.py`](tools/integrations/crawlee_example.py) |
| [Stagehand](https://github.com/browserbase/stagehand) | 21K | TypeScript | [`stagehand.ts`](js/examples/stagehand.ts) |
| [LangChain](https://github.com/langchain-ai/langchain) | 100K+ | Python | [`langchain_loader.py`](tools/integrations/langchain_loader.py) |
| [Selenium](https://github.com/SeleniumHQ/selenium) | — | Python | [`selenium_example.py`](tools/integrations/selenium_example.py) |
| [undetected-chromedriver](https://github.com/ultrafunkamsterdam/undetected-chromedriver) | 12K | Python | [`undetected_chromedriver.py`](tools/integrations/undetected_chromedriver.py) |
| [agent-browser](https://github.com/nichochar/agent-browser) | — | Shell | [`agent_browser.sh`](tools/integrations/agent_browser.sh) |

### Deployment Integrations

| Platform | Example |
|----------|---------|
| [AWS Lambda](https://aws.amazon.com/lambda/) | [`aws_lambda/`](tools/integrations/aws_lambda/) — One-shot scrapes in Lambda (container image) |
