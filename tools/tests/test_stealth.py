...
Usage:
    python tools/stealth_test.py
    python tools/stealth_test.py --headed     # watch in real-time
    python tools/stealth_test.py --no-screenshots
    python tools/stealth_test.py --proxy http://10.50.96.5:8888
"""
